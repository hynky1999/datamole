...
class RestAPITests(unittest.TestCase):
    ...
    def test_average_pr_time(self):
        ...
        response = self.client.get(
            "http://localhost:5000/api/metrics/average_pr_time/test_repo"
        )
        response_dict = json.loads(response.data)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response_dict, {"Time": 600})
    ...
    def test_empty_pr_time(self):
        ...
        response_dict = json.loads(response.data)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response_dict, {"Time": -1})
    ...
    def test_event_counts(self):
        ...
        self.assertEqual(
            reponse_dict,
            {"PullRequestEvent": 1, "IssuesEvent": 1, "WatchEvent": 0},
        )
    ...
    def test_event_counts_per_minute(self):
        ...
        img = create_events_evolution_graph(
            events,
